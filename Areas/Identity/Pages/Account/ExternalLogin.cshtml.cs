...
namespace StudyTracker.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Ошибка загрузки данных внешнего входа.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = "Ошибка загрузки данных внешнего входа при подтверждении.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        private IUserEmailStore<User> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Для внешнего входа требуется хранилище пользователей с поддержкой email.");
            }
